...
Pull requests and feedback are warmly welcomed, the goal is for all to use all features of GitHub, and coding discipline through the use of branches. 💬
...
## There is so so much more we can do with this - check out our guide on Contributing here: [CONTRIBUTING.md](CONTRIBUTING.md)
...
Go build cool things. 🌍 Give us a star, it would be an awesome gesture we've never received.
